                                ...
                                allHistory?.map((book, index) => {
                                    return (
                                        <Table.Row key={index}>
                                            ...
                                            <Table.Cell ><div className={`badge  ${book.status === 'pending delivery' ? 'badge badge-primary' : book.status === 'Dispatched' ? 'badge-secondary' : 'badge-success'}`}>{book.status}</div></Table.Cell>
                                        </Table.Row>
                                    );
                                })
                            }
